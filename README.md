...
Сведения об отправке возвращаются из фоновых заданий отправки в диспетчер отправки, дедуплицируются, объединяются со сведениями о рассмотрении и записываются отложенно, фоновыми заданиями, без ожидания завершения.
...
#### Постобработка при загрузке

#### Отложенная обработка при получении
